...
//  const[date,setDate]=useState('');
 ...
 const [checkstate,setCheckstate]=useState(new Array(12).fill(false));
  ...
  function extra() {
    ...
    nav_active.forEach(ele=>ele.classList.remove('active'))
  }
...
console.error('Error adding data:', error);
  ...
  return (
    <div className="part2">
        ...
        <div className="navbar nav-first">
          <div className="navabar nav-second">
            <div className="navbar navbar-list">
            <i class="fa-solid fa-circle-xmark" onClick={HideMenu}></i>
            <ul>
          <li><Link to="/"><button >Back</button></Link></li>
          <li> <button className={click1 ?"button1" :""}  onClick={home1}>Home</button></li>
          <li>  <button className={click2 ?"button1" :""} onClick={received}>Recieved</button></li>
          <li>  <button className={click3 ?"button1" :""} onClick={pending1}>Pending</button></li>
          <li>  <button className={click4 ?"button1" :""} onClick={extra}>Expenses</button></li>
          <li>  <Link to="/summary" state={{month:month,year:year}}>
        ...
        <div className="part">
         ...
         <div className="my">
        <p ><span>Month:{month}</span><span className="year">Year:{year}</span></p>
      </div>
        ...
        <div>
          <form method="post" onSubmit={SendData}>
            <div className="main">
              ...
              <span className="amount" name="amount" value={Amount}>
                {Amount}
              </span></p>
              <div className="btn2">
            ...
            {rec1 && (
              <div >
                ...
                <div className="flex">
              <p className="totalamount">Received Amount:
              <span className="amount" name="amount" value={Amount}>
                {Amount}
              </span>
              </p>
            ...
            {pend1 && (
              <div>
                ...
                <div className="flex">
              <p className="totalamount">Pending Amount:
              <span className="amount" name="amount" value={Amount}>
                {PendingAmount}
              </span>
              </p>
          ...
          <div >
           ...
           {update && (
            ...
            <tr>
               ...
               <button className="btn1 update" onClick={updateAmount}>update</button>
             </div>
           )}
         </div>
          </div>
